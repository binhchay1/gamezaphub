...
$expired_time = wp_review_option( 'yelp_cache_expired_time', 7 );
?>
...
<div class="wp-review-field">
	<div class="wp-review-field-label">
		<label for="wp_review_yelp_cache_expired_time"><?php esc_html_e( 'Cache expired time', 'wp-review' ); ?></label>
	</div>

	<div class="wp-review-field-option">
		<input name="wp_review_options[yelp_cache_expired_time]" id="wp_review_yelp_cache_expired_time" type="number" value="<?php echo intval( $expired_time ); ?>" min="0" step="1">
