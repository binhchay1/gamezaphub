( function( tinymce, $ ) {
				...
				var dialog = editor.windowManager.open({
					...
					body: [
						...
						},
						{
							type: 'checkbox',
							name: 'show_as_badge',
							label: wprVars.showAsBadge
						},
						{
							type: 'textbox',
							name: 'top',
							label: wprVars.top,
							tooltip: wprVars.showAsBadgeOnly
						},
						{
							type: 'textbox',
							name: 'right',
	...
	function getReviewBadgeButton( editor ) {
		return {
			text: wprVars.reviewBadge,
			onclick: function() {
				var dialog = editor.windowManager.open({
					title: wprVars.reviewBadge,
					body: [
						{
							type: 'textbox',
							name: 'id',
