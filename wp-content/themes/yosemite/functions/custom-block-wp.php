...
{
    wp_enqueue_style('custom-table-styles', get_template_directory_uri() . '/css/custom-table.css', array(), '1.0');
...
{
    wp_enqueue_style('custom-gallery-styles', get_template_directory_uri() . '/css/custom-gallery.css', array(), '1.0');
...
{
    wp_enqueue_script('custom-gallery-minimal', get_template_directory_uri() . '/js/custom-gallery.js', array(), '1.0', true);
...
{
    wp_enqueue_style('custom-video-player-styles', get_template_directory_uri() . '/css/custom-video.css', array(), '1.0');
    wp_enqueue_script('custom-video-player-script', get_template_directory_uri() . '/js/video-player.js', array(), null, true);
...
function add_owl_css_to_all_editors()
{
    ...
    wp_enqueue_script('custom-owl-js', get_template_directory_uri() . '/js/owl-custom.js', array('jquery', 'owl-frontend-js'), '1.0', true);
