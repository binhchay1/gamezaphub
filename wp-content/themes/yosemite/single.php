...
<div id="page" class="single">
	<div class="container">
		...
		<?php if ( isset( $mts_options['mts_single_prevnext'] ) && $mts_options['mts_single_prevnext'] == 2 && !in_the_loop()) { global $post; $post = get_adjacent_post( true, '', false ); if (!empty($post)) { setup_postdata($post); ?>
		<article class="next-article<?php //mts_article_class(); ?>">
			<div id="content_box" class="panel">
				<div id="post-<?php the_ID(); ?>" <?php post_class('g post'); ?>>
		...
		<?php wp_reset_postdata(); } } get_sidebar(); ?>
	</div>
<?php get_footer(); ?>
