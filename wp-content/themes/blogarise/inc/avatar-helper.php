...
if (!class_exists('Blogarise_Avatar_Helper')) {
     ...
     */
    if (!function_exists('blogarise_optimized_avatar')) {
     ...
     */
    if (!function_exists('blogarise_small_avatar')) {
     ...
     */
    if (!function_exists('blogarise_large_avatar')) {
