<?php
if ( ! class_exists( 'Horizon_News_Posts_Grid_And_List_Widget' ) ) {
	/**
	 * Adds Horizon_News_Posts_Grid_And_List_Widget Widget.
	 */
	class Horizon_News_Posts_Grid_And_List_Widget extends WP_Widget {
		...
		public function __construct() {
			$horizon_news_grid_list_widget_ops = array(
				...
				'description' => __( 'Retrive Posts Grid And List Widgets', 'horizon-news' ),
			);
			parent::__construct(
				'horizon_news_grid_list_widget',
				__( 'Ascendoor Grid And List Widget', 'horizon-news' ),
				...
				<div class="magazine-grid-list-section-wrapper">
					...
					if ( $query->have_posts() ) :
						...
						while ( $query->have_posts() ) :
							...
							$classes          = implode( ' ', array( $has_image, $small_list_class ) );
							?>
