<?php
if ( ! class_exists( 'Horizon_News_Posts_List_Widget' ) ) {
	/**
	 * Adds Horizon_News_Posts_List_Widget Widget.
	 */
	class Horizon_News_Posts_List_Widget extends WP_Widget {
		...
		public function __construct() {
			...
			parent::__construct(
				'horizon_news_list_widget',
				__( 'Ascendoor Posts List Widget', 'horizon-news' ),
				...
				<div class="section-header">
					...
					if ( ! empty( $list_button_label ) ) {
						...
						<a href="<?php echo esc_url( $list_button_link ); ?>" class="mag-view-all-link">
							<span><?php echo esc_html( $list_button_label ); ?></span>
						</a>
					<?php } ?>
				</div>
			<?php } ?>
